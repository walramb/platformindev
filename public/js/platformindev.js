...
(function() {
  var AKA, BASETOOL, BLOCKCREATIONTOOL, BLOCKPAINT, Block, BoggleParticle, BugLady, BugMeter, Bullet, CARVER, COLLGRIDSIZE, CUE_DIALOGUE, CURRENT_LEVEL, CURSOR, Cloud, ControlObj, DEPRECATE, Damagebox, DoubleJumper, Energy, EnergyMeter, GenericSprite, Goal, Gold, Grid, HUDLAYER, Hero, HitboxRayIntersect, HurtWire, INIT, Lila, Line2d, MAXBUGSPEED, MLEFT, MOVEBLOCKTOOL, MOVETOOL, MRIGHT, MoneyMeter, MoveBlockTool, MoveTool, NOOPE, NOOPTOOL, ORIGCLICKPOS, OnewayBlock, PP, PchooParticle, Pickup, PlaceholderSprite, Platform, PowerSuit, Rect, Renderable, Robo, SCREENCURS, SPAWNERTOOL, SPAWNTOOL, Shieldbubble, Shrub, Smoochie, Spawner, TELEPORTTOOL, TEXBYNAME, THISFILE, TICKLOG, TILESELECT, TRIANGLETOOL, TextEnt, Thug, Tool, Turret, UNIONTOOL, V, VTOPP, WARN, WATERTOOL, WORLD, WORLDINIT, Water, World, XXXX, _CHARbindingnames, _DEFAULTHITBOXSIZE, _Rectmethods, __snap, _bind, _cycle, _dash, _demotick, _doc, _facing, _lastmodified, _loadcurrlevel, _maketiles, _ml, _move, _particle, _repdupes, _sidestep, _toggleFullScreen, _versionfoot, _wheelin, achieve, actioncategories, adjustedscreensize, adjustmouseevent, allactions, alltools, animate, arr, ascii, assert, audiobaseurl, audiocache, audiocachelength, availableactions, b2n, bglayer_remove_block, bindaction, bindingsDOM, bindingsDOMcontainer, blockcarve, blocksatpoint, blocktextures, blocktools, body, bottomcenter, boxesbounding, boxtouchingwall, browserprefix, bts, bugspeed, bugtextures, bugthrust, but, call, camera, cameraoffset, cameratool, cancelFullScreen, carveoutblock, changelayer, checkcolls, ck, classname, closestpoint, control, css, curraudiotrack, cv, dotfilt, down, drawhitboxes, drawsprite, edithistory, entcenter, entitycount, eventelement, firebullet, fixbox, fontmap, fontsrc, fonttexs, fpscounter, getCursorBlocks, get_sprites_of_class, getentsunderpoint, gettileoffs, highlightoverlaps, hitboxfilter, hitboxfilter_OLD, hitboxlayer, hz, infobox, initsprite, is_firefox, isfullscreen, isholdingbound, isholdingkey, j, jame, jump, k, key, kick, ladybug, launchFullScreen, left, len, level_files, linterpolate, load, loadblocks, loadent, loadents, loadlevel, loadlevelfile, loadspawners, mainloop, makebox, makebutton, maketablerow, maketiles, mktool, mouserightdownhandler, n, nextlevel, noop, normalizekey, o, objnames, parentstage, pausefunc, pausescreen, pausetext, placeshrub, playsound, pointlisttoedges, preload, prevtool, punch, q, randpos, randposrel, randtri, readablebindings, record_l, record_s, recordinputs, ref, ref1, ref2, ref3, relativetobox, removesprite, render, renderer, reserveKeyNamed, reservedkeys, reset_tick_stats, resetstage, restartlevel, results, right, root, save, scale, screensize, screensize_default, selectall, selectframe, setcursor, settings, settingsDOM, settingsDOMcontainer, skipframes, smame, snapmouseadjust, snapmouseadjust_always, snapmouseadjust_down, sourcebaseurl, spawnables, spawnselection, stage, stageremovesprite, stats, string_to_pixi, tb, tickno, ticktimes, tickwaitms, timecall, tmpcanvas, tmpcanvasjq, tmpinnerstage, tmpstage, toggleFullScreen, tool, tool_clickdelete, toolbar, tt, unfuck, up, updateinfobox, updatesettingstable, v, voidcaller, wheel, xmlwrap,
    slice = [].slice,
  ...
  BLOCKCREATIONTOOL = _.extend({}, NOOPTOOL, {
    ...
    mousedown: function(e) {
      ...
      return WORLD.addblock(BLOCKCREATIONTOOL.creatingblock);
    },
    mouseup: function(e) {
