...
(function() {
  var AKA, BASETOOL, BLOCKCREATIONTOOL, BLOCKPAINT, B_MASKING, Bee, Block, BoggleParticle, BugLady, BugMeter, Bullet, Burd, CARVER, COLLGRIDSIZE, COLLTEST_INIT, CURRENT_LEVEL, CURSOR, Claire, Cloud, ControlObj, DEPRECATE, DoubleJumper, Energy, EnergyMeter, Fence, GenericSprite, Goal, Gold, Grid, HUDLAYER, Hat, Hero, HitboxRayIntersect, HurtWire, INIT, Jelly, Lila, Line2d, MAXBUGSPEED, MLEFT, MOVEBLOCKTOOL, MOVETOOL, MRIGHT, MoneyMeter, MoveBlockTool, MoveTool, NOOPTOOL, Noisemaker, ORIGCLICKPOS, OnewayBlock, PP, PchooParticle, Pickup, PlaceholderSprite, Platform, Poly, PowerSuit, ROBOWORLD_INIT, Rect, Renderable, Robo, SCREENCURS, SCREENS, SPAWNERTOOL, SPAWNTOOL, Shieldbubble, Shrub, Smoochie, Spawner, Subscreen, TELEPORTTOOL, TEXBYNAME, THISFILE, TICKLOG, TILESELECT, TRIANGLETOOL, Target, Thug, Tool, Turret, UNIONTOOL, V, VTOPP, WARN, WATERTOOL, WORLD, WORLDINIT, Water, Wisp, World, XXXX, achieve, actioncategories, adjustedscreensize, adjustmouseevent, allactions, alltools, animate, arr, ascii, assert, audiobaseurl, audiocache, audiocachelength, availableactions, b2n, bglayer_remove_block, bindaction, bindingsDOM, bindingsDOMcontainer, blockcarve, blocksatpoint, blocktextures, blocktools, body, bogglescreen, bogimg, bogsprite, bottomcenter, bottomof, boxesbounding, boxtouchingwall, browserprefix, bts, bugspeed, bugtextures, bugthrust, but, call, camera, cameraoffset, cancelFullScreen, carveoutblock, changelayer, char, cheatcodecheck, checkcolls, chievs, ck, classname, closestpoint, control, css, curraudiotrack, cv, dotfilt, down, drawhitboxes, drawsprite, edithistory, entcenter, entitycount, eventelement, firebullet, fixbox, fontmap, fontsrc, fonttexs, fpscounter, getCursorBlocks, get_sprites_of_class, getentsunderpoint, getotherhero, gettileoffs, ghostbusters, glyph, highlightoverlaps, hitboxfilter, hitboxfilter_OLD, hitboxlayer, hslToRgb, hue2rgb, hypesprites, hz, i, infobox, initsprite, is_firefox, isholdingbound, isholdingkey, jame, jump, k, key, keypushcache, kick, konamicode, ladybug, launchFullScreen, left, leftof, level_files, load, loadblocks, loadent, loadents, loadlevel, loadlevelfile, loadspawners, mainloop, makealert, makebox, makechievbox, maketablerow, maketiles, mktool, mousemiddledownhandler, mousemiddleuphandler, mouserightdownhandler, n, nextlevel, noop, normalizekey, objnames, offs, parentstage, pausefunc, pausescreen, pausestring, pausetext, placeshrub, playsound, pointlisttoedges, preload, prevtool, punch, randpos, randposrel, randtri, readablebindings, record_l, record_s, recordinputs, relativetobox, removesprite, render, renderer, reserveKeyNamed, reservedkeys, reset_tick_stats, resetstage, restartlevel, rgbToHex, right, rightof, roboblockdata, root, save, scale, scatterents, scatterents_old, screensize, selectall, selectframe, setcursor, settings, settingsDOM, settingsDOMcontainer, skipframes, smame, snapmouseadjust, snapmouseadjust_always, snapmouseadjust_down, sourcebaseurl, spawnables, spawnselection, spr, stage, stageremovesprite, stats, tb, tex, text, textcontainer, tickno, ticktimes, tickwaitms, timecall, titlescreen, tmpcanvas, tmpcanvasjq, tmpinnerstage, tmpstage, toggleFullScreen, tool, tool_clickdelete, toolbar, topof, tt, unfuck, unzip, up, updateinfobox, updatesettingstable, v, voidcaller, wheel, wspacing, xmlwrap, _CHARbindingnames, _DEFAULTHITBOXSIZE, _Rectmethods, _bind, _ccc, _cycle, _dash, _demotick, _doc, _facing, _i, _j, _k, _l, _lastmodified, _len, _len1, _loadcurrlevel, _maketiles, _ml, _move, _particle, _ref, _ref1, _ref2, _ref3, _ref4, _ref5, _ref6, _ref7, _ref8, _ref9, _repdupes, _results, _sidestep, _versionfoot, _wheelin,
    __slice = [].slice,
  ...
  ascii = String.fromCharCode.apply(this, (function() {
    _results = [];
    for (_j = 32; _j <= 126; _j++){ _results.push(_j); }
    return _results;
  }).apply(this));
  ...
  for (i = _k = 0, _len = pausestring.length; _k < _len; i = ++_k) {
    char = pausestring[i];
    offs = V(32, 64);
    wspacing = 16;
  ...
  Lila.prototype.getsprite = function() {
    ...
    scampercycle = (function() {
      var _l, _results1;
      _results1 = [];
      for (n = _l = 1; _l <= 4; n = ++_l) {
        _results1.push("lilascamper" + n + ".png");
      }
      return _results1;
    })();
    framewait = 4;
  ...
  closestpoint = function(p, pointarr) {
    var closest, point, _l, _len1;
    closest = pointarr[0];
    for (_l = 0, _len1 = pointarr.length; _l < _len1; _l++) {
      point = pointarr[_l];
  ...
  BugLady.prototype.smashblock = function() {
    var block, blockcandidates, collidebox, _l, _len1, _results1;
    collidebox = this.gethitbox();
    blockcandidates = hitboxfilter(collidebox, WORLD.bglayer);
    _results1 = [];
    for (_l = 0, _len1 = blockcandidates.length; _l < _len1; _l++) {
      block = blockcandidates[_l];
      if (block.src !== "genblackrocks.png") {
        continue;
      }
      WORLD.bglayer = _.without(WORLD.bglayer, block);
      _results1.push(block.removesprite());
    }
    return _results1;
  };
  ...
  boxtouchingwall = function(collidebox) {
    var block, blockcandidates, notontop, _l, _len1;
    blockcandidates = hitboxfilter(collidebox, WORLD.bglayer);
    for (_l = 0, _len1 = blockcandidates.length; _l < _len1; _l++) {
      block = blockcandidates[_l];
  ...
  GenericSprite.prototype.avoidwalls = function() {
    var actualbox, block, blockcandidates, collidebox, jumpthroughable, notontop, _l, _len1, _results1;
  ...
  GenericSprite.prototype.touchingground = function() {
    var allpolygons, block, blockcandidates, box, collidebox, fromgrid, otherboxes, touch, _l, _len1,
      _this = this;
    touch = false;
    collidebox = this.gethitbox();
  ...
  GenericSprite.prototype.touchingspritename = function(spritename) {
    var allpolygons, block, blockcandidates, box, cands, collidebox, touch, _l, _len1,
      _this = this;
    touch = false;
    collidebox = this.gethitbox();
  ...
  MoneyMeter = (function(_super) {
    ...
    MoneyMeter.prototype.tick = function() {
      var hhh, _len2, _m, _results1;
      this.update(ladybug.score);
      _results1 = [];
      for (_m = 0, _len2 = hypesprites.length; _m < _len2; _m++) {
        spr = hypesprites[_m];
        hhh = spr.x / 200 - tickno / 20;
        spr.tint = rgbToHex(hslToRgb(hhh % 1, 1, 0.5));
        _results1.push(spr.anchor.y = 0.5 - Math.sin(tickno + spr.x / 16) / 8);
      }
      return _results1;
    };
  ...
  scatterents_old = function(classproto, num) {
    ...
    return WORLD.spritelayer = WORLD.spritelayer.concat((function() {
      _results1 = [];
      for (var _m = 0; 0 <= num ? _m < num : _m > num; 0 <= num ? _m++ : _m--){ _results1.push(_m); }
      return _results1;
  ...
  */
  ...
  WORLD.collgrid = {
    ...
    getraw: function(rect, ignore) {
      ...
      ar = ((_ref7 = this.contents) != null ? _ref7[i] : void 0) || [];
      ar = ar.filter(function(objrect) {
        var _ref8;
        return _ref8 = objrect.obj, __indexOf.call(ignore, _ref8) < 0;
      });
      return ar;
    },
  ...
  WORLD.tick = function() {
    var ACTIVEENTS, _base, _len2, _m, _ref7;
    _demotick();
    reset_tick_stats();
  ...
  updatesettingstable = function() {
    ...
    for (k in settings) {
      ...
      _results1.push(settingsDOM.append(maketablerow([k, tempv])));
    }
    return _results1;
  };
  ...
  blockcarve = function(aa, bb) {
    var a, b, blok, blokx, x1, x2, x3, x4, y1, y2, y3, y4, _len2, _m, _results1;
    ...
    _results1 = [];
    for (_m = 0, _len2 = blokx.length; _m < _len2; _m++) {
      blok = blokx[_m];
      _results1.push(WORLD.addblock(blok));
    }
    return _results1;
  };
  ...
  carveoutblock = function(b) {
    var block, bloke, tocarve, todelete, _len2, _len3, _m, _n, _results1;
    block = new Block(b.x, b.y, b.w, b.h);
    tocarve = block.allstrictoverlaps();
    for (_m = 0, _len2 = tocarve.length; _m < _len2; _m++) {
      bloke = tocarve[_m];
      blockcarve(bloke, block);
    }
    todelete = block.allstrictoverlaps();
    _results1 = [];
    for (_n = 0, _len3 = todelete.length; _n < _len3; _n++) {
      bloke = todelete[_n];
      WORLD.bglayer = _.without(WORLD.bglayer, bloke);
      if (bloke._pixisprite != null) {
        _results1.push(stage.removeChild(bloke._pixisprite));
      } else {
        _results1.push(void 0);
      }
    }
  ...
  WATERTOOL = _.extend({}, NOOPTOOL, {
    ...
    mousedown: function(e) {
      var adjusted, bl, blocksundercursor, _len2, _m, _results1;
      if (e.button !== 0) {
        return;
      }
      adjusted = adjustmouseevent(e);
      ...
      _results1 = [];
      for (_m = 0, _len2 = blocksundercursor.length; _m < _len2; _m++) {
        bl = blocksundercursor[_m];
        WORLD.spritelayer.unshift(new Water(bl.x, bl.y, bl.w, bl.h));
        _results1.push(bglayer_remove_block(bl));
      }
      return _results1;
    }
  });
  ...
  mktool({
    name: "painter",
    action: function(p) {
      var bl, _len2, _m, _ref10, _results1;
      _ref10 = getCursorBlocks();
      _results1 = [];
      for (_m = 0, _len2 = _ref10.length; _m < _len2; _m++) {
        bl = _ref10[_m];
        bl.tile = TILESELECT;
        _results1.push(bl.removesprite());
      }
      return _results1;
    }
  });
  ...
  allactions['spawn block under hero'] = function() {
    ...
    return WORLD.addblock(creatingblock);
  };
  ...
  actioncategories["level editing"] = {
    "align all blocks to grid": function() {
      var block, gridsize, _len2, _m, _ref10, _results1;
      gridsize = settings.gridsize;
  ...
  _wheelin = function(offs) {
    var bl, size, _len2, _m, _ref10, _results1;
...
/*
//@ sourceMappingURL=platformindev.map
*/
