...
(function() {
  var BLOCKCREATIONTOOL, B_MASKING, Block, BoggleParticle, BugLady, BugMeter, Bullet, Burd, CARVER, COLLTEST_INIT, Claire, Cloud, ControlObj, Energy, EnergyMeter, Fence, GenericSprite, Goal, Gold, Grid, Hat, Hero, HitboxRayIntersect, HurtWire, INIT, Jelly, Lila, Line2d, MOVEBLOCKTOOL, MOVETOOL, MoneyMeter, MoveBlockTool, MoveTool, NOOPTOOL, ORIGCLICKPOS, OTHERCHAR_SUBSCREEN, PP, PchooParticle, Pickup, PlaceholderSprite, Platform, PlayerBurd, Poly, PowerSuit, ROBOWORLD_INIT, Renderable, Robo, SPAWNERTOOL, SPAWNTOOL, Shrub, Smoochie, Spawner, TELEPORTTOOL, THISFILE, TRIANGLETOOL, Target, Thug, Tool, UNIONTOOL, V, VTOPP, WATERTOOL, WORLD, WORLDINIT, WORLD_ONE_INIT, Water, World, achieve, adjustedscreensize, adjustmouseevent, allactions, alltools, animate, audiobaseurl, availableactions, bglayer_remove_block, bindaction, bindingsDOM, blockcarve, blockdata, blocksatpoint, body, bogglescreen, bogimg, bogsprite, bottomcenter, bottomof, boxesbounding, boxtouchingwall, bugspeed, but, camera, cameraoffset, cancelFullScreen, carveoutblock, cheatcodecheck, checkcolls, chievs, classname, closestpoint, control, down, drawhitboxes, drawsprite, entcenter, entdata, entitycount, eventelement, firebullet, fixbox, fpscounter, get_sprites_of_class, getentsunderpoint, getotherhero, highlightoverlaps, hitboxfilter, hitboxlayer, infobox, initsprite, isholdingbound, isholdingkey, jame, k, keypushcache, kick, ladybug, lastmodified, launchFullScreen, left, leftof, load, loadblocks, loadent, loadents, loadlevel, loadlevelfile, loadspawners, mainloop, makebox, makechievbox, maketablerow, mousemiddledownhandler, mousemiddleuphandler, mouserightdownhandler, nextlevel, normalizekey, objnames, parentstage, pausefunc, pausescreen, pausetext, placeshrub, playsound, pointlisttoedges, punch, randpos, randposrel, randtri, readablebindings, relativetobox, removesprite, render, renderer, resetstage, restartlevel, right, rightof, roboblockdata, root, save, scale, scatterents, screensize, selectall, selectframe, setcursor, settings, settingsDOM, skipframes, snapmouseadjust, sourcebaseurl, spawnables, spawnselection, stage, tex, text, tickno, ticktimes, tickwaitms, timecall, titlescreen, tmpcanvas, tmpcanvasjq, tmpinnerstage, tmpstage, toggleFullScreen, tool, toolbar, topof, tt, unzip, up, updateinfobox, updatesettingstable, v, xmlwrap, _CHARbindingnames, _DEFAULTHITBOXSIZE, _ref, _ref1, _ref2, _ref3, _ref4, _ref5, _ref6,
  ...
  OTHERCHAR_SUBSCREEN = {
    init: function() {
      ...
      if (B_MASKING) {
        ...
        return parentstage.addChild(this.mask);
      }
    },
    maskupdate: function() {
      this.mask.clear();
  ...
  OTHERCHAR_SUBSCREEN.subscreenadjust = function() {
    var hero, oldpos, subscreencentercam;
  ...
  animate = function() {
    ...
    return OTHERCHAR_SUBSCREEN.subscreenadjust();
  };
  ...
  Grid.prototype.PIXINIT = Cloud.prototype.PIXINIT = function() {
    ...
    if (!this._pixisprite) {
      ...
      this._pixisprite = sprit;
      return stage.addChildAt(sprit, 0);
    }
  };
  ...
  */
  ...
  jame.burdme = function() {
    ...
    return WORLD.entities.push(ladybug);
  };
