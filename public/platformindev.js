...
(function() {
  var Block, BoggleParticle, BugLady, Cloud, ControlObj, GenericSprite, Jelly, Layer, PchooParticle, PowerSuit, Sky, Sprite, Target, V, WORLD, achieve, animate, arrclone, arrsansval, availableactions, bglayer, body, boggletitles, bogimg, bottomof, brickcanvas, brickctx, bricklayer, bugsprites, cachedimg, cacheflippedimg, camera, cameraoffset, canvas, canvascircle, checkcolls, chievs, control, ctx, ded, degstorads, down, drawcolls, drawoutline, drawsprite, entcenter, entitycount, falltitles, fglayer, fieldgoaltitles, flipimg, fpscounter, hitboxfilter, hueshift, hueshiftmemo, isholdingkey, ladybug, left, leftof, load, loadimg, logtimecall, looptick, mainloop, makechievbox, marlsprites, murdertitles, normalizekey, parentstage, placeshrub, preload, preloadcontainer, rainbowhuh, randelem, randfloat, randint, randvec, rectsoverlap, removesprite, render, renderer, right, rightof, save, scale, screensize, settings, skipframes, skylayer, sourcebaseurl, sources, spritedrawhitbox, spritelayer, stage, targettitles, tickno, ticktimes, tickwaitms, tilebackground, tilebackgroundobj, timecall, tmpcanvas, tmpcanvasjq, tmpctx, topof, tt, up,
  ...
  BoggleParticle.prototype.render = function(ctx) {
    ...
    drawsprite(this, 'huh.png', this.pos, false);
