...
(function() {
  ...
  Thug = (function(_super) {
    ...
    Thug.prototype.render = function() {
      ...
      return sprit.anchor = VTOPP(anchor);
    };
  ...
  BugLady.prototype.friction = function() {
  ...
  _ref = control.bindings;
  for (k in _ref) {
    v = _ref[k];
    bindingsDOM.append(maketablerow([String.fromCharCode(k), control.bindingnames[k] || "??"]));
  }
