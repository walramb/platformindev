...
(function() {
  ...
  BugLady.prototype.blockcollisions = function() {
    ...
    return candidates.forEach(function(candidate) {
      ...
      if (_this.vel.y < 0 && !jumpthroughable) {
        return _this.vel.y = 0;
      }
    });
  };
