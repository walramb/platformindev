...
(function() {
  var $blockpal, BASETOOL, BLOCKCREATIONTOOL, BLOCKPAINT, B_MASKING, Bee, Block, BoggleParticle, BugLady, BugMeter, Bullet, Burd, CARVER, COLLTEST_INIT, CURRENT_LEVEL, Claire, Cloud, ControlObj, DoubleJumper, Energy, EnergyMeter, Fence, GenericSprite, Goal, Gold, Grid, HUDLAYER, Hat, Hero, HitboxRayIntersect, HurtWire, INIT, Jelly, Lila, Line2d, MAXBUGSPEED, MOVEBLOCKTOOL, MOVETOOL, MoneyMeter, MoveBlockTool, MoveTool, NOOPTOOL, ORIGCLICKPOS, OnewayBlock, PP, PchooParticle, Pickup, PlaceholderSprite, Platform, Poly, PowerSuit, ROBOWORLD_INIT, Renderable, Robo, SCREENS, SPAWNERTOOL, SPAWNTOOL, Shieldbubble, Shrub, Smoochie, Spawner, Subscreen, TELEPORTTOOL, THISFILE, TRIANGLETOOL, Target, Thug, Tool, Turret, UNIONTOOL, V, VTOPP, WATERTOOL, WORLD, WORLDINIT, Water, Wisp, World, achieve, actioncategories, adjustedscreensize, adjustmouseevent, allactions, alltools, animate, audiobaseurl, audiocache, audiocachelength, availableactions, bglayer_remove_block, bindaction, bindingsDOM, blockcarve, blockpalette, blocksatpoint, body, bogglescreen, bogimg, bogsprite, bottomcenter, bottomof, boxesbounding, boxtouchingwall, browserprefix, bugspeed, but, camera, cameraoffset, cancelFullScreen, carveoutblock, cheatcodecheck, checkcolls, chievs, ck, classname, closestpoint, control, curraudiotrack, cv, down, drawhitboxes, drawsprite, edithistory, entcenter, entitycount, eventelement, exorcism, firebullet, fixbox, fpscounter, get_sprites_of_class, getentsunderpoint, getotherhero, highlightoverlaps, hitboxfilter, hitboxfilter_OLD, hitboxlayer, infobox, initsprite, isholdingbound, isholdingkey, jame, jump, k, key, keypushcache, kick, ladybug, lastmodified, launchFullScreen, left, leftof, level_files, load, loadblocks, loadent, loadents, loadlevel, loadlevelfile, loadspawners, mainloop, makebox, makechievbox, maketablerow, mousemiddledownhandler, mousemiddleuphandler, mouserightdownhandler, n, nextlevel, normalizekey, objnames, parentstage, pausefunc, pausescreen, pausetext, placeshrub, playsound, pointlisttoedges, punch, randpos, randposrel, randtri, readablebindings, relativetobox, removesprite, render, renderer, reserveKeyNamed, reservedkeys, reset_tick_stats, resetstage, restartlevel, right, rightof, roboblockdata, root, save, scale, scatterents, scatterents_old, screensize, selectall, selectedtexture, selectframe, setcursor, settings, settingsDOM, skipframes, snapmouseadjust, snapmouseadjust_always, snapmouseadjust_down, sourcebaseurl, spawnables, spawnselection, stage, stageremovesprite, stats, tex, text, tickno, ticktimes, tickwaitms, timecall, titlescreen, tmpcanvas, tmpcanvasjq, tmpinnerstage, tmpstage, toggleFullScreen, tool, toolbar, topof, tt, unfuck, unzip, up, updateinfobox, updatesettingstable, urlify, v, xmlwrap, _CHARbindingnames, _DEFAULTHITBOXSIZE, _i, _j, _len, _ref, _ref1, _ref2, _ref3, _ref4, _ref5, _ref6, _ref7, _ref8, _ref9,
  ...
  BugLady.prototype.jumpimpulse = function(jumpvel) {
    ...
    if (this.touchingground()) {
      ...
      this.timers.jumpgraceperiod = 10;
    ...
    doublejumplegal = this.vel.y >= 0 && !unpowered && settings.airjump && this.energy > 0;
