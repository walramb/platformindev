...
(function() {
  var $blockpal, BASETOOL, BLOCKCREATIONTOOL, BLOCKPAINT, B_MASKING, Bee, Block, BoggleParticle, BugLady, BugMeter, Bullet, Burd, CARVER, COLLTEST_INIT, CURRENT_LEVEL, Claire, Cloud, ControlObj, DoubleJumper, Energy, EnergyMeter, Fence, GenericSprite, Goal, Gold, Grid, HUDLAYER, Hat, Hero, HitboxRayIntersect, HurtWire, INIT, Jelly, Lila, Line2d, MAXBUGSPEED, MOVEBLOCKTOOL, MOVETOOL, MoneyMeter, MoveBlockTool, MoveTool, NOOPTOOL, Noisemaker, ORIGCLICKPOS, OnewayBlock, PP, PchooParticle, Pickup, PlaceholderSprite, Platform, Poly, PowerSuit, ROBOWORLD_INIT, Renderable, Robo, SCREENS, SPAWNERTOOL, SPAWNTOOL, Shieldbubble, Shrub, Smoochie, Spawner, Subscreen, TELEPORTTOOL, THISFILE, TRIANGLETOOL, Target, Thug, Tool, Turret, UNIONTOOL, V, VTOPP, WATERTOOL, WORLD, WORLDINIT, Water, Wisp, World, achieve, actioncategories, adjustedscreensize, adjustmouseevent, allactions, alltools, animate, audiobaseurl, audiocache, audiocachelength, availableactions, bglayer_remove_block, bindaction, bindingsDOM, bindingsDOMcontainer, blockcarve, blockpalette, blocksatpoint, blocktools, body, bogglescreen, bogimg, bogsprite, bottomcenter, bottomof, boxesbounding, boxtouchingwall, browserprefix, bugspeed, bugthrust, but, camera, cameraoffset, cancelFullScreen, carveoutblock, cheatcodecheck, checkcolls, chievs, ck, classname, closestpoint, control, curraudiotrack, cv, dotfilt, down, drawhitboxes, drawsprite, edithistory, entcenter, entitycount, eventelement, exorcism, firebullet, fixbox, fpscounter, get_sprites_of_class, getentsunderpoint, getotherhero, highlightoverlaps, hitboxfilter, hitboxfilter_OLD, hitboxlayer, infobox, initsprite, is_firefox, isholdingbound, isholdingkey, jame, jump, k, key, keypushcache, kick, ladybug, lastmodified, launchFullScreen, left, leftof, level_files, load, loadblocks, loadent, loadents, loadlevel, loadlevelfile, loadspawners, mainloop, makebox, makechievbox, maketablerow, mousemiddledownhandler, mousemiddleuphandler, mouserightdownhandler, n, nextlevel, normalizekey, objnames, parentstage, pausefunc, pausescreen, pausetext, placeshrub, playsound, pointlisttoedges, punch, randpos, randposrel, randtri, readablebindings, relativetobox, removesprite, render, renderer, reserveKeyNamed, reservedkeys, reset_tick_stats, resetstage, restartlevel, right, rightof, roboblockdata, root, save, scale, scatterents, scatterents_old, screensize, selectall, selectedtexture, selectframe, setcursor, settings, settingsDOM, settingsDOMcontainer, skipframes, snapmouseadjust, snapmouseadjust_always, snapmouseadjust_down, sourcebaseurl, spawnables, spawnselection, stage, stageremovesprite, stats, tex, text, tickno, ticktimes, tickwaitms, timecall, titlescreen, tmpcanvas, tmpcanvasjq, tmpinnerstage, tmpstage, toggleFullScreen, tool, tool_clickdelete, toolbar, topof, tt, unfuck, unzip, up, updateinfobox, updatesettingstable, urlify, v, xmlwrap, _CHARbindingnames, _DEFAULTHITBOXSIZE, _i, _j, _len, _ref, _ref1, _ref2, _ref3, _ref4, _ref5, _ref6, _ref7, _ref8, _ref9,
  ...
  for (n = _i = 0; 0 <= audiocachelength ? _i < audiocachelength : _i > audiocachelength; n = 0 <= audiocachelength ? ++_i : --_i) {
  ...
  Noisemaker = (function(_super) {
    __extends(Noisemaker, _super);
  ...
  Target = (function(_super) {
    ...
    Target.prototype.collide = function(otherent) {
      ...
      if ((((_ref = otherent.timers) != null ? _ref.attack : void 0) != null) && ((_ref1 = otherent.timers) != null ? _ref1.attack : void 0) > 0) {
  ...
  Jelly = (function(_super) {
    ...
    Jelly.prototype.collide = function(otherent) {
      ...
      timeout = (_ref = otherent.timers) != null ? _ref.attack : void 0;
  ...
  Thug.prototype.collide = function(otherent) {
    ...
    if ((((_ref = otherent.timers) != null ? _ref.attack : void 0) != null) && ((_ref1 = otherent.timers) != null ? _ref1.attack : void 0) > 0 && this.lifetime <= 0) {
      this.vel = this.vel.vadd(otherent.vel.nmul(1 / 2));
      this.gethitby(otherent);
    }
    if (otherent instanceof Hero && ((_ref2 = otherent.timers) != null ? _ref2.invincible : void 0) === 0) {
  ...
  Turret = (function(_super) {
    ...
    function Turret() {
      _ref2 = Turret.__super__.constructor.apply(this, arguments);
      return _ref2;
    }
  ...
  Burd.prototype.collide = function(otherent) {
    ...
    timeout = (_ref3 = otherent.timers) != null ? _ref3.attack : void 0;
    if ((timeout != null) && timeout > 0) {
      return this.gethitby(otherent);
    }
  };
  ...
  PchooParticle = (function(_super) {
    ...
    PchooParticle.prototype.render = function() {
      ...
      return this._pixisprite.rotation = Math.atan2(this.vel.y, this.vel.x);
    };
  ...
  Shieldbubble = (function(_super) {
    __extends(Shieldbubble, _super);

    function Shieldbubble(pos) {
      this.pos = pos != null ? pos : V();
      this.owner = ladybug;
      this.src = 'bubble.png';
      this.anchor = V(1 / 2, 1);
  ...
  BugLady.prototype.flinch = function() {
    ...
    return this.timers.invincible = 20;
  };
  ...
  closestpoint = function(p, pointarr) {
    var closest, point, _j, _len;
    closest = pointarr[0];
    for (_j = 0, _len = pointarr.length; _j < _len; _j++) {
      point = pointarr[_j];
  ...
  BugLady.prototype.canhurdle = function() {
    ...
    if (b_hitsomething && b_cansqueezein) {
      return true;
    }
    return false;
  };
  ...
  BugLady.prototype.smashblock = function() {
    var block, blockcandidates, collidebox, _j, _len, _results;
    collidebox = this.gethitbox();
    blockcandidates = hitboxfilter(collidebox, WORLD.bglayer);
    _results = [];
    for (_j = 0, _len = blockcandidates.length; _j < _len; _j++) {
      block = blockcandidates[_j];
      if (block.src !== "genblackrocks.png") {
        continue;
      }
      WORLD.bglayer = _.without(WORLD.bglayer, block);
      _results.push(block.removesprite());
    }
    return _results;
  };
  ...
  BugLady.prototype.movetick = function() {
    ...
    if (this.vel.y > 1 && this.controls.crouch && this.shield) {
      ladybug.shield.KILLME = true;
      ladybug.shield = null;
  ...
  BugLady.prototype.getsprite = function() {
    ...
    if (this.timers.invincible > 10 && this.touchingground()) {
      src = "bugflinch.png";
    }
    if (this.timers.invincible > 15) {
      src = "bugdmg.png";
    }
    if (this.timers.invincible > 0 && !this.touchingground()) {
      src = "bugdmg2.png";
    }
    if (settings.pone) {
      src = "pone/" + src;
  ...
  Claire = (function(_super) {
    ...
    function Claire() {
      _ref3 = Claire.__super__.constructor.apply(this, arguments);
      return _ref3;
    }
  ...
  Wisp = (function(_super) {
    __extends(Wisp, _super);

    function Wisp() {
      _ref4 = Wisp.__super__.constructor.apply(this, arguments);
      return _ref4;
    }
  ...
  BugLady.prototype.render = function() {
    ...
    if (this.timers.stun) {
      return sprit.alpha = tickno % 2;
    } else {
      return sprit.alpha = 1;
    }
  };
  ...
  boxtouchingwall = function(collidebox) {
    var block, blockcandidates, notontop, _j, _len;
    blockcandidates = hitboxfilter(collidebox, WORLD.bglayer);
    for (_j = 0, _len = blockcandidates.length; _j < _len; _j++) {
      block = blockcandidates[_j];
  ...
  GenericSprite.prototype.avoidwalls = function() {
    var actualbox, block, blockcandidates, collidebox, jumpthroughable, notontop, _j, _len, _results;
  ...
  GenericSprite.prototype.touchingground = function() {
    var allpolygons, block, blockcandidates, box, collidebox, otherboxes, touch, _j, _len,
      _this = this;
    touch = false;
    collidebox = this.gethitbox();
    WORLD.updateboxes();
  ...
  GenericSprite.prototype.touchingspritename = function(spritename) {
    var allpolygons, block, blockcandidates, box, cands, collidebox, touch, _j, _len,
      _this = this;
    touch = false;
    collidebox = this.gethitbox();
  ...
  exorcism = function() {
    ...
    return spooky_ghosts.forEach(function(spoop) {
      return spoop.KILLME = true;
    });
  };

  control.keytapbindname('h', 'ghost mode', function() {
    var ghost, ghosts_are_real;
    ghosts_are_real = entitycount(Wisp) > 0;
    if (ghosts_are_real) {
      return exorcism();
    } else {
      ghost = new Wisp();
      WORLD.spritelayer.push(ghost);
      return ghost.pos = ladybug.pos;
    }
  });
  ...
  control.keytapbindname('e', 'shield', function() {
    var sb;
  ...
  bugthrust = function(vel) {
    ladybug.vel.x = vel;
    ladybug.vel.y = 0;
    return ladybug.timers.hover = 20;
  };
  ...
  control.keyholdbindname('q', 'cling', function() {});
  ...
  eventelement.bind('keydown', function(e) {
    ...
    if (__indexOf.call(reservedkeys, key) >= 0) {
      return false;
    }
  });
  ...
  Block.prototype.render = function() {
    var difx, leftwise, refpoint, sprit, threshold;
    if (!this.hassprite()) {
      this.initsprite();
    }
    sprit = this._pixisprite;
  ...
  Grid.prototype.PIXINIT = Cloud.prototype.PIXINIT = function() {
    ...
    if (!this._pixisprite) {
      tex = PIXI.Texture.fromImage(sourcebaseurl + this.src);
      _ref6 = adjustedscreensize(), x = _ref6.x, y = _ref6.y;
  ...
  DoubleJumper = (function(_super) {
    __extends(DoubleJumper, _super);

    function DoubleJumper(pos) {
      this.pos = pos;
  ...
  Block.prototype.toJSON = function() {
    return [this.x, this.y, this.w, this.h, this.src];
  };
  ...
  scatterents_old = function(classproto, num) {
    ...
    return WORLD.spritelayer = WORLD.spritelayer.concat((function() {
      _results = [];
      for (var _k = 0; 0 <= num ? _k < num : _k > num; 0 <= num ? _k++ : _k--){ _results.push(_k); }
      return _results;
  ...
  HurtWire = (function(_super) {
    ...
    function HurtWire() {
      _ref6 = HurtWire.__super__.constructor.apply(this, arguments);
      return _ref6;
    }
  ...
  */
  ...
  WORLD.updateboxes = function() {
    ...
    return JELS.forEach(function(ent) {
      var box;
      box = typeof ent.gethitbox === "function" ? ent.gethitbox() : void 0;
      if (box) {
        return WORLD.BOXCACHE.push(box);
      }
    });
  };

  WORLD.tick = function() {
    var ACTIVEENTS, _base, _k, _len1, _ref7;
    reset_tick_stats();
    _ref7 = control.heldkeys;
    ...
    WORLD.euthanasia();
    ACTIVEENTS = [].concat(WORLD.spritelayer, WORLD.entities);
  ...
  updatesettingstable = function() {
    ...
    for (k in settings) {
      v = settings[k];
      if (v === true || v === false) {
        tempv = "<button onclick=\"jame.settings." + k + "=!jame.settings." + k + "\">" + v + "</button>";
      } else {
        tempv = v;
      }
      _results.push(settingsDOM.append(maketablerow([k, tempv])));
    }
    return _results;
  };
  ...
  MoveTool = (function(_super) {
    ...
    function MoveTool() {
      _ref9 = MoveTool.__super__.constructor.apply(this, arguments);
      return _ref9;
    }
  ...
  blockcarve = function(aa, bb) {
    var a, b, blok, blokx, x1, x2, x3, x4, y1, y2, y3, y4, _k, _len1, _results;
    ...
    _results = [];
    for (_k = 0, _len1 = blokx.length; _k < _len1; _k++) {
      blok = blokx[_k];
  ...
  carveoutblock = function(b) {
    var block, bloke, tocarve, todelete, _k, _l, _len1, _len2, _results;
    block = new Block(b.x, b.y, b.w, b.h);
    tocarve = block.allstrictoverlaps();
    for (_k = 0, _len1 = tocarve.length; _k < _len1; _k++) {
      bloke = tocarve[_k];
      blockcarve(bloke, block);
    }
    todelete = block.allstrictoverlaps();
    _results = [];
    for (_l = 0, _len2 = todelete.length; _l < _len2; _l++) {
      bloke = todelete[_l];
  ...
  WATERTOOL = _.extend({}, NOOPTOOL, {
    ...
    mousedown: function(e) {
      var adjusted, bl, blocksundercursor, _k, _len1, _results;
      if (e.button !== 0) {
        return;
      }
      adjusted = adjustmouseevent(e);
      ...
      _results = [];
      for (_k = 0, _len1 = blocksundercursor.length; _k < _len1; _k++) {
        bl = blocksundercursor[_k];
  ...
  BLOCKPAINT = _.extend({}, BASETOOL, {
    ...
    action: function(p) {
      ...
      if (blocksundercursor.length === 0) {
        ...
        return newblock.src = selectedtexture;
      }
    },
  ...
  actioncategories["level editing"] = {
    "align all blocks to grid": function() {
      var block, gridsize, _k, _len1, _ref10, _results;
      gridsize = settings.gridsize;
      _ref10 = WORLD.bglayer;
      _results = [];
  ...
  for (ck in actioncategories) {
    ...
    toolbar.append($(xmltag('em', void 0, "" + ck + " actions: ")));
    for (k in cv) {
      v = cv[k];
      but = $(xmltag('button', void 0, k));
      but.click(v);
  ...
  edithistory = {
    ...
    undo: function() {
      ...
      if (type === "remove") {
        console.log(ent);
        return WORLD.bglayer.push(ent);
      }
    }
  };

  control.keyBindRawNamed(keyCharToCode['Backspace'], 'undo', function() {
  ...
  selectedtexture = blockpalette = ["genbrick", "genblackrocks", "groundtile", "redtile", "genice"];

  urlify = function(str) {
    return "url(" + sourcebaseurl + str + ".png)";
  };

  $blockpal = $("<div>");

  blockpalette.forEach(function(tex) {
    var buton;
    buton = $("<button>");
    buton.css({
      width: 64,
    ...
    buton.css("background-image", urlify(tex));
    buton.click(function() {
      return selectedtexture = tex + ".png";
    });
    return $blockpal.append(buton);
  });
