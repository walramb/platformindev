...
(function() {
  var Block, BoggleParticle, BugLady, ControlObj, GenericSprite, Jelly, Layer, PchooParticle, PowerSuit, Sprite, Target, V, WORLD, achieve, animate, arrclone, arrsansval, availableactions, bglayer, body, boggletitles, bogimg, bottomof, brickcanvas, brickctx, bricklayer, bugsprites, cachedimg, cacheflippedimg, camera, canvas, canvascircle, checkcolls, chievs, control, ctx, ded, degstorads, down, drawcolls, drawoutline, drawsprite, entcenter, entitycount, falltitles, fglayer, fieldgoaltitles, flipimg, fpscounter, hitboxfilter, hueshift, hueshiftmemo, isholdingkey, ladybug, left, leftof, load, loadimg, logtimecall, looptick, mainloop, makechievbox, marlsprites, murdertitles, normalizekey, placeshrub, preload, preloadcontainer, rainbowhuh, randelem, randfloat, randint, randvec, rectsoverlap, render, renderer, right, rightof, save, settings, skipframes, skylayer, sourcebaseurl, sources, spritedrawhitbox, spritelayer, stage, tickno, ticktimes, tickwaitms, tilebackground, tilebackgroundobj, timecall, tmpcanvas, tmpcanvasjq, tmpctx, topof, tt, up,
  ...
  BoggleParticle.prototype.render = function(ctx) {
    ...
    ctx.drawImage(pic, this.pos.x, this.pos.y);
  ...
  BugLady.prototype.render = function(ctx) {
    var censor, flip, offsety, pos, src, vel, walking;
    offsety = 3;
    ...
    pos = V(this.pos.x, this.pos.y + offsety);
    drawsprite(this, src, pos, flip);
    if (censor) {
